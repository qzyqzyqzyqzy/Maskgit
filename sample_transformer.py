...
parser.add_argument('--resolution', type=int, default=64, help='generate resolution')
...
for i in tqdm(range(n)):
    ...
    sos_tokens = torch.ones(start_indices.shape[0], 1) 
    sos_tokens = sos_tokens.long().to("cuda")
    sample_indices = transformer.sample(start_indices, sos_tokens, steps=256,resolution=32)#resolrtion=32,64
