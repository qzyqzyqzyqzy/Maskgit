...
class TrainVQGAN:
    ...
    def train(self, args):
        ...
        steps_per_epoch = min(len(train_dataset1),len(train_dataset2))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--latent-dim', type=int, default=512, help='Latent dimension n_z (default: 512)')
    parser.add_argument('--image-size', type=int, default=64, help='Image height and width (default: 64)')
    ...
    parser.add_argument('--dataset-path', type=str, default='./owndataset', help='Path to data (default: /data)')
